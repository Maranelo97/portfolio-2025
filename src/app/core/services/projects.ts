...
const MOCK_PROJECTS: IProject[] = [
  {
    ...
    fullDescription:
      'Desarrollo de un sistema E-commerce de principio a fin, enfatizando la performance y la seguridad. El frontend utiliza NgRx para la gestión de estado y el backend, construido con NestJS (Node.js), implementa microservicios para autenticación y pagos.',
  ...
  },
  {
    ...
    fullDescription:
      'Página de marketing diseñada para captar la atención del usuario a través de animaciones cinéticas. Se utilizó la integración profunda de GSAP con Angular para garantizar que las animaciones sean fluidas y no afecten el rendimiento de la aplicación ni el SSR.',
...
export class ProjectsService {
  ...
  getProjectById(id: string): Observable<IProject | null> {
    // <-- Definimos el tipo de retorno como IProject | null
